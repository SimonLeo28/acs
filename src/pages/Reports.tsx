...
const LINE_OPTIONS = [
  ...
  { value: "TLCSD",      label: "TLCSD" },
  { value: "WaterLine",  label: "WaterLine" },
  { value: "KHS",        label: "KHS" },
  { value: "TetraTCA",   label: "TetraTCA" },
  { value: "TetraTBA",   label: "TetraTBA" },
  { value: "HotFillLine",label: "HotFillLine" },
      ...
      <aside className="w-64 bg-sidebar border-r border-sidebar-border flex flex-col shrink-0">
        ...
        <nav className="flex-1 p-3 space-y-1">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-sidebar-accent/50 text-sm transition-colors"
          >
            <LayoutDashboard className="w-4 h-4" /> Dashboard
          </button>
          <button className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg bg-sidebar-accent text-foreground text-sm font-medium">
        ...
        <div className="p-3 border-t border-sidebar-border">
          <button
            onClick={() => navigate("/")}
            className="w-full flex items-center gap-3 px-4 py-2.5 rounded-lg text-muted-foreground hover:text-destructive hover:bg-destructive/10 text-sm transition-colors"
          >
            <LogOut className="w-4 h-4" /> Logout
          </button>
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="bg-blue-900 w-full  border border-border rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/50 transition-all"
